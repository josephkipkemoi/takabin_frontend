...
import { faUserPlus, faInfoCircle, faStepBackward } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className="card border-0">
                ...
                <div className="card-body">
                    ...
                    <div className="mt-1">                            
                                ...
                                {signupSteps === 2 && 
                                    <>
                                        <button className="btn" onClick={handlePreviousStep}>
                                            <FontAwesomeIcon icon={faStepBackward} style={{ marginRight: 8 }}/>
                                            Go Back
                                        </button>
                                        <button 
                                            className="btn btn-primary w-100 p-3 rounded-0" 
                        ...
                        <p className="d-flex align-items-center mt-3 mb-3">
                    ...
                    <div className="text-center">
                        <span className="span-line">Or signup with</span>
                        <div className="d-flex flex-column mt-3 mb-3">
                            <button className="btn btn-outline-success p-3 w-100 m-1 d-flex justify-content-center align-items-center">
                            ...
                            <button className="btn btn-outline-primary p-3 w-100 m-1 d-flex justify-content-center align-items-center">
