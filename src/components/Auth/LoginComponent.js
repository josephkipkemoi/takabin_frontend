        ...
        <div className="bg-light row mt-3 p-5 gx-5 gy-3">
            <div className="col-lg-3 col-md-4 col-sm-12 bg-white rounded shadow d-flex align-items-center justify-content-center">
                <div className="card border-0 bg-white">
                    ...
                    <div className="text-center">
                        <span className="span-line">Or login with</span>
                        <div className="d-flex flex-column mt-3 mb-3">
                            <button className="btn btn-outline-success d-flex justify-content-center align-items-center p-3 w-100 m-1">
                            ...
                            <button className="btn btn-outline-primary d-flex justify-content-center align-items-center p-3 w-100 m-1">
            ...
            <div className="col-lg-9 col-md-8 col-sm-12">
                <div className="img-holder">
                    <img src={LoginImg} className="img-fluid rounded-0 img-landing" alt="login-img"/>
                </div>
            </div>
