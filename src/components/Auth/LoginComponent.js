                ...
                <div className="card border-0 bg-white">
                    ...
                    <div className="text-center">
                        ...
                        <div className="d-flex mt-3">
                            <button className="btn btn-outline-success d-flex justify-content-center align-items-center p-3 w-100 m-2">
                            ...
                            <button className="btn btn-outline-primary d-flex justify-content-center align-items-center p-3 w-100 m-2">
